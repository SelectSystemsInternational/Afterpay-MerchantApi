...
namespace MerchantApi.Model
{
    ...
    public partial class CreateCheckoutRequest:  IEquatable<CreateCheckoutRequest>, IValidatableObject
    {
        ...
        /// <param name="Consumer">The consumer requesting the order. (required).</param>
        ...
        public CreateCheckoutRequest(string Token = default(string), string Expires = default(string), string RedirectCheckoutUrl = default(string), 
            Money Amount = default(Money), Consumer Consumer = default(Consumer), Contact Billing = default(Contact), Contact Shipping = default(Contact), ShippingCourier Courier = default(ShippingCourier),  
