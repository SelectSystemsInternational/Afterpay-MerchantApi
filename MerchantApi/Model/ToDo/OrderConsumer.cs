...
namespace MerchantApi.Model
{
    ...
    public partial class OrderConsumer :  IEquatable<OrderConsumer>, IValidatableObject
    {
        ...
        public OrderConsumer(string PhoneNumber = default(string), string GivenNames = default(string), string Surname = default(string), string Email = default(string))
        {
            ...
            {
                throw new InvalidDataException("PhoneNumber length is greatter than 32 Characters");
            }
            else
            {
            ...
            else if (GivenNames.Length > 128)
            {
                throw new InvalidDataException("GivenNames length is greatter than 128 Characters");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("Surname length is greatter than 128 Characters");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("Email length is greatter than 128 Characters");
            }
            else
            {
                this.Email = Email;
