...
namespace MerchantApi.Model
{
    ...
    public partial class CreateOrderRequest :  IEquatable<CreateOrderRequest>, IValidatableObject
    {
        ...
        public CreateOrderRequest(TypeEnum? ProductType = default(TypeEnum?), decimal? Amount = default(decimal?), Consumer Consumer = default(Consumer), Contact Billing = default(Contact), 
            Contact Shipping = default(Contact), string Description = default(string), List<Item> Items = default(List<Item>), Merchant Merchant = default(Merchant), 
