...
namespace MerchantApi.Model
{
    ...
    public partial class CheckoutOrder :  IEquatable<CheckoutOrder>, IValidatableObject
    {
        ...
        public CheckoutOrder(string OrderId = default(string), string OrderNumber = default(string), decimal? Amount = default(decimal?),
            OrderConsumer Consumer = default(OrderConsumer), Contact Billing = default(Contact), Contact Shipping = default(Contact), string Description = default(string), 
            List<Item> Items = default(List<Item>), Merchant Merchant = default(Merchant), string MerchantReference = default(string), 
