...
namespace MerchantApi.Model
{
    ...
    public partial class Authentication :  IEquatable<Authentication>, IValidatableObject
    {
        ...
        public Authentication(Money MaximumAmount = default(Money))
        {
            // to ensure "MaximumAmount" is required (not null)
            if (MaximumAmount == null)
            {
                throw new InvalidDataException("MaximumAmount is a required property for Authentication and cannot be null");
            }
            else
            {
